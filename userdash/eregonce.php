                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="http://Amarjeet.asia" title="logo" target="_blank">
                            <img width="60" src="http://Amarjeet.asia/images/logo.png" title="logo" alt="logo">
                          </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            Your account has been created on the Amarjeet.asia. <br><strong>"Unlock your earning potential with your newly created account and start making money through the power of Pair Punch!"</strong>.</p>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>

                                        <a href="http://Amarjeet.asia/userdash/"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>www.Amarjeet.asia</strong> </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
...
$content = '
    Welcome to Amarjeet.asia!
    
    Dear ' . $name . ',
    Thank you for joining Amarjeet.asia. We are thrilled to have you on board!
    Your account details:
    
        User ID: ' . $email . '
        Password: ' . $password . '
   
    We believe that Amarjeet.asia will provide you with great opportunities and help you unlock your earning potential.
    If you have any questions or need assistance, feel free to contact our support team.
    Once again, welcome to Amarjeet.asia! We wish you a successful and rewarding experience.
    
    
    
    Best regards,
    The Amarjeet.asia Team
';

$to = $emailid;
$subject = 'Welcome To Amarjeet';
$message = $content;

$headers = array(
    'From' => 'Amarjeet.asia@gmail.com',
    'Reply-To' => 'Amarjeet.asia@gmail.com',
...
// $sender_name = "Amarjeet.asia";
// 	$sender_email = "Amarjeet.asia@gmail.com";
// 	//
// 	$username = "Amarjeet.asia@gmail.com";
// 	$password = "ruiwjzyzirdvrhct";
// 	//
// 	$receiver_email = $emailid;
// 	$message = $admin_body;
// 	$subject = "Thank You - Amarjeet";
