<?php include('menu.php');?> 
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>  
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                             <a href="order.php?id=<?php echo $id?>&user=<?php echo $userid?>"><img src="../<?php echo $row['picture'];?>" alt="product" class="responsive" width="270px" height="200px"></a> 
                        </div>
                    </div>
                </div>
                <?php
    ...
    <!-- Jquery Core Js -->
    <script src="../userdash/dplugins/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core Js -->
    <script src="../userdash/dplugins/bootstrap/js/bootstrap.js"></script>

    <!-- Select Plugin Js -->
    <script src="../userdash/dplugins/bootstrap-select/js/bootstrap-select.js"></script>

    <!-- Slimscroll Plugin Js -->
    <script src="../userdash/dplugins/jquery-slimscroll/jquery.slimscroll.js"></script>

    <!-- Waves Effect Plugin Js -->
    <script src="../userdash/dplugins/node-waves/waves.js"></script>

    <!-- Wait Me Plugin Js -->
    <script src="../userdash/dplugins/waitme/waitMe.js"></script>

    <!-- Custom Js -->
    <script src="../userdash/djs/admin.js"></script>
    <script src="djs/pages/cards/colored.js"></script>

    <!-- Demo Js -->
    <script src="../userdash/djs/demo.js"></script>
</body>
</html>
