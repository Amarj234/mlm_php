...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            ...
            <!-- <a href="javascript:void(0);"><b>Amarjeet</b></a> -->
    ...
    <script src="../userdash/dplugins/jquery-validation/jquery.validate.js"></script>

    <!-- Custom Js -->
    <script src="../userdash/djs/admin.js"></script>
    <script src="../userdash/djs/pages/examples/sign-in.js"></script>
</body>
