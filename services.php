...
<body>
  ...
  <div class="footer_section layout_padding margin_0">
    <div class="container">
      <div class="footer_main">
        ...
        <h1 class="landing_text">Join the Amarjeet movement and become part of a supportive community of individuals
  ...
  <div class="copyright_section">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <p class="copyright_text">2023 All Rights Reserved Design by <a href="#"> Amarjeet</p>
        </div>
      </div>
    </div>
  </div>
